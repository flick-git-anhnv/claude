...
| 7.2 | Frontend: hiển thị token thật (input/output/cache) cho từng step trong PipelineCard/StepStation | Junior Developer | ⬜ | `steps/STEP-7.2-jd-token-step-ui.md` | - |
