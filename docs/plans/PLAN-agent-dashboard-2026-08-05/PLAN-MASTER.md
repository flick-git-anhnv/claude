...
| 2026-08-07 14:00 | Bước 8.3 ✅ — Backend Sprint 5: usage_service.py (NEW, httpx Bearer, _pct(), cache 60s), /usage/active + /{acc_id}/usage routes, BUG-004 chain_updated WS broadcast trong main.py, FR-004 Dispatcher node prepend trong get_session_chain, FR-005 get_pipeline_aggregate + GET /api/pipeline/aggregate. 22 tests Sprint 5 + sửa regression 22 assertions Sprint 3/4. 250/250 pytest PASS. CODE-GRAPH v1.7 cập nhật. | Senior Developer |
