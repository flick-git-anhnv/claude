---
# Kiro steering doc — generated by scripts/skillgen_kztek.py
# Source: .claude/commands/verify-pr.md
inclusion: manual
---

<!-- Platform: Kiro AI IDE | Source: .claude/commands/verify-pr.md -->
<!-- KHÔNG sửa trực tiếp — sửa source rồi chạy: python scripts/skillgen_kztek.py -->
